...
public class SIPRequestTemplate
{
	...
	public static final String TMPL_ADD_MOBILE_BUDDY = "<args><contacts><mobile-buddies><mobile-buddy uri=\"{uri}\" buddy-lists=\"{cordId}\" desc=\"{desc}\" invite=\"0\" addbuddy-phrase-id=\"0\" /></mobile-buddies></contacts></args>s";
